...
<div id="postbox-main" class="ps-postbox clearfix" style="">
	...
	<div class="ps-postbox-tab ps-postbox-tab-root clearfix">
		<ul class="ps-list-inline">
			<?php peepso('general', 'post-types', array('is_current_user' => isset($is_current_user) ? $is_current_user : NULL)); ?>
		</ul>
	</div>

	<nav class="ps-postbox-tab selected interactions" style="display: none;">
		<ul class="ps-list-inline">
			<?php peepso('postbox', 'post-interactions', array('is_current_user' => isset($is_current_user) ? $is_current_user : NULL)); ?>
		</ul>
