<div id="dialog-upload-cover">
	...
	<div id="dialog-upload-cover-content">
		...
		<ul class="ps-list <?php if (peepso('profile', 'has-cover')) { echo 'ps-list-half'; } ?> upload-cover">
			...
			<li class="ps-list-item">
				<a href="javascript:void(0);" onclick="profile.remove_cover_photo(<?php peepso('profile', 'user-id'); ?>);" class="ps-btn ps-btn-danger ps-full"><?php _e('Remove Cover Photo', 'peepso'); ?></a>
			</li>
			<?php } ?>
