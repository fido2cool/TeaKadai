...
<script type="text/javascript">
	(function($) {
		var modalHtml =
				...
				+ '	<div class="ps-dialog">'
				+ '     <h2 class="ps-dialog__title"><?php echo __('Plugin Usage Feedback', 'peepso'); ?></h2>'
				...
				+ '			<h3 class="ps-dialog__subtitle"><?php echo __('Please tell us how can we make this plugin better for you?', 'peepso'); ?></h3>'
				+ '			<select name="peepso-deactivation-reason-dropdown">'
				+ '				<option>Select Reason</option>'
				+ '				<option value="not_for_me"><?php echo __("It\'s not what I\'m looking for", 'peepso'); ?></option>'
				+ '				<option value="found_alternative"><?php echo __("I Found a better alternative", 'peepso'); ?></option>'
				+ '				<option value="technical_problems"><?php echo __("It didn\'t work for me, technical problems", 'peepso'); ?></option>'
				+ '				<option value="other"><?php echo __("Other", 'peepso'); ?></option>'
				+ '			</select>'
				...
				+ '			<span class="ps-form__helper"><?php echo __('(*) Your feedback will only be used to improve this plugin', 'peepso'); ?></span>'
				+ '			</div>'
				+ '		</div>'
				+ '		<div class="ps-dialog__footer">'
				+ '			<a href="#" class="button button-primary button-close"><?php echo _x('Cancel', 'the text of the cancel button of the plugin deactivation dialog box.', 'peepso'); ?></a>'
		...
		function peepsoUpdateButtonLabels() {
			...
			if ('confirm' === peepsoGetCurrentPanel()) {
				$deactivateButton.text('<?php echo __('Yes - Deactivate', 'peepso'); ?>');
			} else {
				$deactivateButton.text('<?php echo __('Deactivate', 'peepso'); ?>');
			}
		}
