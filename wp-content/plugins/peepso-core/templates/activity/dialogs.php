	...
	<div id="ps-profile-delete-dialog">
		...
		<div id="profile-delete-content">
			<div>
				...
				<button type="button" name="rep_cacel" class="ps-btn ps-button-cancel" onclick="pswindow.hide(); return false;"><?php _e('Cancel', 'peepso'); ?></button>
				&nbsp;
				<button type="button" name="rep_submit" class="ps-btn ps-button-action" onclick="profile.delete_profile_action(); return false;"><?php _e('Delete My Profile', 'peepso'); ?></button>
			</div>
		</div>
	</div>
