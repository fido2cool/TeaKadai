<div class="ps-stream ps-js-activity ps-js-activity--<?php echo $act_id; ?>" data-id="<?php echo $act_id; ?>">
	...
	<div class="ps-stream-body">
		<div class="ps-stream-attachment cstream-attachment"><?php peepso('activity', 'content'); ?></div>
		<div class="ps-stream-attachments cstream-attachments"><?php peepso('activity', 'post-attachment'); ?></div>
	</div>
