<div class="ps-js-modal-attachment--<?php echo $act_id; ?>">
	...
	<div class="ps-stream-actions stream-actions" data-type="stream-action">
		...
		<div id="act-like-<?php echo $act_id; ?>" class="cstream-likes ps-js-act-like--<?php echo $act_id; ?>" data-count="<?php echo $likes ?>">
			<?php peepso('activity', 'show-like-count', $likes); ?>
		</div>
		<?php } else { ?>
		<div id="act-like-<?php echo $act_id; ?>" class="cstream-likes ps-js-act-like--<?php echo $act_id; ?>" data-count="0" style="display:none"></div>
		<?php } ?>
