...
class PeepSoFormValidate
{
	...
	public function __construct($type, $options = array())
	{
		...
		$this->_error_messages = array(
			...
			'username' => __('This field only accepts alpha letters, numbers, dashes(-), and underscores(_), or email addresses.', 'peepso'),
			'past' => __('Please enter a date in the past.', 'peepso'),
			'maxlen' => __('This field is too long, maximum length: %d.', 'peepso'),
			'minlen' => __('This field is too short, minimum length: %d.', 'peepso'),
