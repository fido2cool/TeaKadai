...
class PeepSoMailqueueListTable extends PeepSoListTable 
{
	...
	public function get_columns()
	{
		return array(
			...
			'mail_recipient' => __('Recipient & Subject', 'peepso'),
	...
	public function extra_tablenav($which)
	{
		if ('top' === $which) {
			...
			if(0 == PeepSo::get_option('disable_mailqueue',0)) {
				...
				echo '<span><a href=?page=peepso_config&tab=advanced>', __('The default Mailqueue is disabled', 'peepso'),'</a></span>';
				echo '</div>', PHP_EOL;
			}
		}
	}
